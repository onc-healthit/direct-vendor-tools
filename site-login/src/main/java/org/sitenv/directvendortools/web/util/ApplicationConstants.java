...
public class ApplicationConstants {
	...
	public static final String ACCOUNT_REGISTER_SERVICE = "accountRegisterService";
	...
	public static final String POC_FIRST_NAME ="pocFirstName";
	public static final String POC_LAST_NAME ="pocLastName";
