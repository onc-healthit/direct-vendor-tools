...
import org.sitenv.bl.AccountRegisterProcess;
...
public class AccountRegisterService {
			...
			final String inputData)
	{
		...
		try
		{
			    ...
			    {
			    	accountRegistryOutput = ApplicationUtil.getFormattedOutput(new ResponseTO(new GenericErrorTO(ApplicationConstants.EMAIL_REGISTERED_ERROR)), isJSon);
			    }
